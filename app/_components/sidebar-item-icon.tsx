export function SidebarItemIcon({ type }: { type: string }) {
  switch (type) {
    ...
    case "dropdown":
      return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><rect x="1" y="3.5" width="11" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.2"/><path d="M3 6.5h5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/><path d="M9 5.5l1.5 1-1.5 1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>;
    case "search":
    ...
    case "callout":
      return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><rect x="4" y="1.5" width="7.5" height="10" rx="1" stroke="currentColor" strokeWidth="1.2"/><rect x="1" y="1.5" width="2.5" height="10" rx="1.25" fill="currentColor"/></svg>;
    case "tabs":
