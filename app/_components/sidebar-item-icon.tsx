export function SidebarItemIcon({ type }: { type: string }) {
  switch (type) {
    ...
    case "callout":
      return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><rect x="1" y="1.5" width="11" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.2"/><circle cx="3.75" cy="3.75" r=".9" fill="currentColor"/><rect x="3.15" y="5.25" width="1.2" height="4" rx="0.4" fill="currentColor"/><path d="M5.75 5.75h5.5M5.75 8.25h4.5" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/></svg>;
    case "tabs":
    ...
    case "section":
      return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><path d="M1.5 3h5.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><path d="M1 5.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><path d="M1.5 8h7.5M1.5 10h5.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/></svg>;
    case "step-rail":
      return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><circle cx="2.5" cy="2.5" r="1.1" fill="currentColor"/><circle cx="2.5" cy="6" r="1.1" stroke="currentColor" strokeWidth="1.1"/><circle cx="2.5" cy="9.5" r="1.1" stroke="currentColor" strokeWidth="1.1"/><path d="M2.5 3.6v1.3M2.5 7.1v1.3" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/><path d="M5 2.5h6.5M5 6h4M5 9.5h5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>;
    case "carousel":
